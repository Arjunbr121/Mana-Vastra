export const CATEGORIES = [
  ...
  { key: "Silk", label: "Silk Saree" },
  { key: "Cotton", label: "Cotton Saree" },
  { key: "Designer", label: "Designer Saree" },
  { key: "Fancy", label: "Fancy Saree" },
  { key: "Ilkal", label: "Ilkal Saree" },
  { key: "Banarasi", label: "Banarasi Saree" },
  { key: "Daily", label: "Daily Wear Saree" },
];
