...
const API = `${import.meta.env.VITE_API_URL || "https://mana-vastra-backend.onrender.com/api"}`;

const BACKEND = import.meta.env.VITE_API_URL?.replace("/api", "") || "https://mana-vastra-backend.onrender.com";
